...
// @ts-nocheck 
/*
 * This file exports the `MCC` model and its related types.
 *
...
export type GetMCCAggregateType<T extends MCCAggregateArgs> = {
      [P in keyof T & keyof AggregateMCC]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateMCC[P]>
    : Prisma.GetScalarType<T[P], AggregateMCC[P]>
}
...
type GetMCCGroupByPayload<T extends MCCGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<MCCGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof MCCGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], MCCGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], MCCGroupByOutputType[P]>
      }
    >
  >
...
export type MCCCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<MCCFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface MCCDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['MCC'], meta: { name: 'MCC' } }
  /**
   ...
   * })
  **/
  count<T extends MCCCountArgs>(
    args?: Prisma.Subset<T, MCCCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], MCCCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, MCCGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetMCCGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
